...
def get_detailed_listing_database(html_file):
    ...
    for x in first_part:
        second_element = get_listing_information(x[2])
        list_of_tuples.append(x + second_element)
...
def write_csv(data, filename):
    ...
    new_data = column_headers + data_1
    # print(new_data)
    with open(filename, "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerows(new_data)

# write_csv(get_detailed_listing_database("html_files/mission_district_search_results.html"), "AirBnb Data")
